...
const TYPES = {
  ...
  dark: {
    intro:
      "Place this pet in a mysterious dark-themed fantasy scene. The pet keeps its real body but is enhanced with magical shadow and void effects and a haunting moonlit environment.",
    enhancements: [
      "Wisps of living shadow curl off the pet's fur like dark smoke, drifting lazily into the air. The eyes glow an eerie pale silver-white. A faint dark aura pulses around the body, dimming the light in the immediate area.",
      "The pet's shadow on the ground is alive — it moves independently, stretching and shifting with its own will. Dark energy particles drift upward from the fur like black snow. A crescent moon mark glows faintly on the forehead.",
      "Tendrils of shadow extend from beneath the pet, creeping along the ground in all directions. The fur has a subtle dark iridescence — shifting between deep blue and black depending on the light. The eyes glow deep crimson red.",
      "A cloak of living darkness drapes behind the pet like a royal shadow mantle. Floating orbs of dark energy orbit the body slowly. The fur seems to absorb light around it, creating a subtle vignette effect. Faint ghostly wisps trail from the tail.",
      "The pet is surrounded by slowly swirling dark mist that hugs the ground. Small shadow creatures — barely visible — peer from the darkness behind it. The eyes glow an intense icy blue. The fur has a moonlit silver sheen at the tips.",
      "Dark crystalline formations float near the pet's paws, absorbing light. A spectral shadow aura — like a second silhouette — extends behind and above the pet, larger and more menacing. The fur ripples with waves of darkness like oil on water.",
    ],
    poses: [
      "standing silently in a pool of moonlight as shadows gather around its paws",
      "emerging from absolute darkness, only the glowing eyes visible at first, body materializing from shadow",
      "perched atop a crumbling gothic spire silhouetted against an enormous full moon",
      "walking through a dark forest as shadows bend toward it like it's their master",
      "sitting regally on a throne of twisted dark crystal in a ruined cathedral",
      "mid-stride through a field of black roses under a blood-red moon",
      "standing at the edge of a cliff overlooking a vast dark void below",
      "crouching in shadows with only its glowing eyes piercing the darkness",
      "howling at an eclipsed moon as shadows spiral upward from its body",
      "standing in the center of a dark ritual circle with glowing runes on the ground",
    ],
    effects: [
      "eerie pale silver-white glowing eyes that pierce through darkness",
      "deep crimson-red glowing eyes like smoldering coals in shadow",
      "wisps of living shadow curling off the fur like dark smoke",
      "a dark aura that dims and absorbs light in the immediate area",
      "the pet's shadow moving independently with its own will",
      "dark energy particles drifting upward from the fur like black snow",
      "faint ghostly wisps trailing from the tail and ears",
      "a subtle vignette effect where the pet absorbs surrounding light",
    ],
    environments: [
      "a haunted gothic cathedral in ruins under a massive full moon, moonbeams and shadows painted as one flowing dark composition",
      "a dark enchanted forest where the trees have glowing eyes and the shadows are alive, everything dissolving into painterly darkness at the edges",
      "a vast graveyard on a hilltop under a blood-red eclipsed moon, mist and moonlight blending into soft impressionistic strokes",
      "a crumbling dark castle perched on a cliff above a sea of black clouds, the pet and architecture merging in shadow",
      "a moonlit swamp with dead trees and glowing will-o-wisps, the water reflecting an impossibly starry sky",
      "an ancient dark temple deep underground with only faint purple crystal light, the pet emerging from the void",
      "a field of black roses under a sky full of stars and a crescent moon, the darkness and pet flowing together as one painting",
      "a shadowy dimension where the ground is made of dark mirrors reflecting a distorted starfield, the pet at the center of the void",
    ],
    style:
      "Dark moody palette — deep blacks, midnight blues, dark purples, pale moonlight silvers, and occasional blood-red accents. " + ART_STYLE,
  },
};
