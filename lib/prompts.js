...
const TYPES = {
  ...
  dark: {
    intro:
      "Place this pet in a haunting dark-themed fantasy scene. The pet keeps its real body but is enhanced with shadow magic, moonlit energy, and an eerie supernatural environment.",
    enhancements: [
      "Tendrils of living shadow curl upward from the ground and wrap loosely around the pet like dark smoke. The pet's eyes glow with an eerie pale violet light. A faint spectral aura of deep purple-black energy clings to the fur like a second skin.",
      "A massive ghostly shadow — a larger, more menacing version of the pet — looms behind it with glowing white eyes. Wisps of dark mist trail from the pet's paws and tail. The fur has subtle dark rune-like markings that pulse with faint violet light.",
      "The pet is partially cloaked in swirling dark fog that seems alive and sentient. One eye glows icy blue, the other deep crimson. Shadow tendrils extend from the pet's silhouette like spectral wings or tendrils reaching into the darkness.",
      "A crescent moon hovers directly behind the pet's head like a dark halo. Black mist pools at the paws and drifts upward defying gravity. The pet's shadow on the ground is far larger than it should be and appears to move independently.",
      "Dark energy crackles around the pet in arcs of deep purple and black lightning. The fur seems to absorb light making the pet appear darker than its surroundings. Ghostly wisps of silver energy orbit the body like tiny lost souls.",
      "The pet emerges from a rift of pure shadow energy — a tear in reality with swirling darkness behind it. The edges of the pet's silhouette blur into shadow as if the pet is half-phantom. Eyes glow with cold supernatural intensity.",
    ],
    poses: [
      "sitting perfectly still and poised on a high ledge silhouetted against a massive full moon",
      "emerging from deep shadow with only glowing eyes and partial body visible",
      "prowling forward low to the ground with predatory grace and glowing eyes locked on something unseen",
      "standing atop ancient ruins looking down with calm commanding presence",
      "mid-stride walking through thick fog with shadow tendrils trailing behind",
      "perched on a gnarled dead tree branch overlooking a misty valley below",
      "rearing up with shadow energy exploding outward from its body in all directions",
      "lying sphinx-like on a stone altar with an air of ancient dark wisdom",
      "turning to look over its shoulder with one glowing eye visible and shadows swirling",
      "howling or calling upward toward a crescent moon with dark energy radiating skyward",
    ],
    effects: [
      "glowing pale violet eyes that pierce through darkness",
      "eerie mismatched eyes — one icy blue and one deep crimson",
      "living shadow tendrils curling from the paws and tail",
      "a spectral dark aura that absorbs surrounding light",
      "dark purple-black lightning crackling around the body",
      "a shadow on the ground that is far larger and moves independently",
      "ghostly silver wisps orbiting the body like lost spirits",
      "fur marked with faintly glowing dark runes or sigils",
    ],
    environments: [
      "a fog-choked graveyard under a massive full moon, ancient tombstones and twisted iron fences dissolving into the painted mist",
      "a dark enchanted forest where the trees have glowing eyes and the paths twist into shadow, the scene rendered in deep moody brushstrokes",
      "the rooftop of a Gothic cathedral at midnight with gargoyles and moonlight, the city below lost in painted fog and shadow",
      "a still black lake reflecting a blood-red moon, dead trees lining the shore like skeletal hands reaching upward",
      "ancient catacombs lit only by floating spectral candles, stone walls covered in glowing runes and the darkness alive with movement",
      "a crumbling dark castle throne room with moonlight streaming through shattered stained glass windows, dust and shadow swirling together",
      "a desolate moor under a stormy sky with lightning illuminating standing stones, the landscape raw and painted in dark washes",
      "a void between worlds — abstract swirling darkness with floating stone fragments and distant dying stars, the pet the only solid presence",
    ],
    style:
