...
// v10 — framing sandwiched at START and END of every prompt
...
export const TYPE_PROMPTS = {
  fire: {
    prompt:
      "IMPORTANT: This must be a WIDE SHOT full-body portrait. The dog must be centered in the frame with its ENTIRE body fully visible — top of head, ear tips, all four paws, and tail — with generous empty space above and below. Do not crop any part of the dog. " +
      ...
      "REMINDER: WIDE SHOT. The dog's full body must be completely visible and centered with space above the head and below the paws. No cropping.",
  },
  water: {
    prompt:
      "IMPORTANT: This must be a WIDE SHOT full-body portrait. The dog must be centered in the frame with its ENTIRE body fully visible — top of head, ear tips, all four paws, and tail — with generous empty space above and below. Do not crop any part of the dog. " +
