...
// v6 — added full-body framing directive to prevent head/tail cutoff
...
export const TYPE_PROMPTS = {
  fire: {
    prompt:
      ...
      "Compose the image so the dog's entire body including the full head, ears, and tail are fully visible within the frame with generous padding above and around the subject. " +
