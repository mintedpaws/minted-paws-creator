...
export const TYPE_PROMPTS = {
  fire: {
   ...
   "Remove the leash, collar, harness, and all accessories completely from this dog. " +
      ...
      "Place the dog in a powerful heroic pose: standing boldly atop a volcanic rock ledge with a wide commanding stance, chest forward, head raised with confidence, fiery tail blazing behind it. " +
