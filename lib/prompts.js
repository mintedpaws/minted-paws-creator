...
// v9 — richly descriptive with extensive pose/environment menus
//       maximum variety between generations while staying on-type
...
export const TYPE_PROMPTS = {
  fire: {
    prompt:
      ...
      "CRITICAL FRAMING: Compose this as a full-body portrait with the dog centered in the middle of the image. Leave generous empty space above the head and below the paws. The dog's full body — head, ears, all four paws, and tail — must be completely visible with no cropping whatsoever.",
  },
  water: {
    prompt:
