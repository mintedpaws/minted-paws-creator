...
const TYPES = {
  ...
  dark: {
    intro:
      "Place this pet in a fierce dark-themed fantasy scene. The pet keeps its real body but is enhanced with magical battle effects and a warrior environment.",
    enhancements: [
      ...
      "A spectral shadow — a larger, fiercer version of the pet — looms behind it like a ghostly guardian. The eyes glow with intense dark energy. Small rocks and debris levitate around the body from the energy output.",
      ...
      "The pet is surrounded by swirling wind and energy. Glowing battle scars trace across the body pulsing with inner power. A focused beam of dark energy energy rises from the pet like a pillar. Pebbles hover in the air from the force.",
      "Chains of glowing energy wrap loosely around the pet's forearms like spectral bracers. The eyes burn with crimson dark energy. A shockwave ring expands outward from the pet's position. Cherry blossom petals and dust swirl in the energy.",
    ],
    poses: [
    ...
    effects: [
      "intense glowing ice-blue eyes burning with dark energy",
    ...
    environments: [
      ...
      "a shadowy underground arena carved from raw stone with dramatic torch lighting, shadows and flame merging into the painted scene",
    ],
    style:
